...
public class RelativizeTest01 {
    public static void main(String[] args) {
        ...
        Path clazz = Paths.get("/home/bryan/dev/olaMundo.java");

        Path pathToClazz = dir.relativize(clazz);
        System.out.println(pathToClazz);

        Path absoluto01 = Paths.get("/home/bryan");
        Path absoluto02 = Paths.get("/user/local");
        Path absoluto03 = Paths.get("/home/bryan/dev/olaMundo.java");
        Path relativo01 = Paths.get("temp");
        Path relativo02 = Paths.get("temp/temp.32453253");
        ...
        System.out.println("5 " + absoluto01.relativize(relativo01));
    }
}
