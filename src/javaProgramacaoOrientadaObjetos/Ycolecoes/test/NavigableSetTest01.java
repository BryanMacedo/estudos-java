...
public class NavigableSetTest01 {
    public static void main(String[] args) {
        ...
        NavigableSet<Manga> mangas = new TreeSet<>(new MangaPrecoComparator()); // ordena automaticamente com base no compareTo
        ...
        mangas.add(new Manga(10L, "Aaragondfdfdfdfdfdfd", 11.20, 2));
